...
function dd() {
	...
	part3 = '';
	part4 = '/apps/dev_functions/sirdownloadalot.php'; //We use this URL to process KML
	var cqlStr;
...
function photoscrollsetter(firetype, imageURL){
	...
	if (firetype=='setup'){
		...
		if(imageURL.substring(0,1)=="#"){
			...
			$.get("../../apps/dev_functions/photocarousel.php", {imageURLStr: imageURL}, function(data){
