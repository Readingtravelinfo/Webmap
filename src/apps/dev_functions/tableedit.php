...
switch($function):
	...
	Case 'view':
		...
		print "<img src=\"../../apps/dev_functions/blank.jpg\" onLoad=\"lowerSet( '" . $recNo . "', '" . $lower . "')\" />";
		$colNoStr = "";
		...
		for ($tb=0;$tb<($tableLoopsno);$tb++) {
			...
			$res = pg_query($dbconn, $query) or header( print "<img src=\"../../apps/dev_functions/blank.jpg\" onLoad=\"resetView('" . $table . "', " . $recNos[$tb] . ", " . $lowers[$tb] . ", 0)\" />");
	...
	case 'blank':
		...
		break;
	default:
		print "<img src='../../apps/dev_functions/blank.jpg' onload=\"resetView('" . $table . "', " . $recNos[0] . ", " . $lowers[0] . ", 0)\" />";
		break;
endswitch;
