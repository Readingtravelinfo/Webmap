...
switch($function):
	Case 'edit':
			...
			if ($ex==1){
				...
				if ($sel==1){
					...
					if ($statusValueno > 0) {
						...
						print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /></td></tr>\n";
					...
					//Anything else
						print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . $inputSize . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /></td></tr>\n";
					}
				} elseif ($sel==3) {
					//Option List
					print "<td class='EditValue'>
					...
					//Normal Text
					print "<td class='EditValue'><textarea class='disabled' readonly='readonly' rows='5' cols='" . $colsSize . "' id='T" . $fnarray[$j] . "' name='T" . $fnarray[$j] . "'>" . $formValue . "</textarea></td></tr>\n";
				...
				if ($sel==1){
					...
					if ($statusValueno > 0) {
						...
						print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /><font color='grey'>Please add a number</font></td></tr>\n";
					} elseif (substr($ftarray[$j],0,4)=="time") {
						print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /><font color='grey'>Please add a timestamp (yyyy-mm-dd hh:mm:ss<a href='#' alt='You may need to add the timezone'>*</a>)</font></td></tr>\n";
					} elseif (substr($ftarray[$j],0,4)=="date") {
						print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /><font color='grey'>Please add a date (yyyy-mm-dd)</font></td></tr>\n";
					} else {
					//Anything else
						print "<td class='EditValue'><input type='textbox' size='" . $inputSize . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='" . $formValue . "' /></td></tr>\n";
					}
				} elseif ($sel==3) {
					//Option List
					print "<td class='EditValue'>
					...
					//Normal Text
					print "<td class='EditValue'><textarea  rows='5' cols='" . $colsSize . "' id='T" . $fnarray[$j] . "' name='T" . $fnarray[$j] . "'>" . $formValue . "</textarea></td></tr>\n";
				} elseif ($ftarray[$j]=="bool") {
					//Booleans (yes/no)
					if ($formValue=='t'){
		...
		//Insert a submit buttom
		print "<tr><td><input type='hidden' id='Itable' name='Itable' value='" . $qtable . "' /><input type='hidden' id='Iproj' name='Iproj' value='" . $proj . "' /><input type='button' onclick='gedCall(\"" . $qtable . "\", \"update\")' value='Update Row' /></td><td><input type='button' onclick='gedCall(\"" . $qtable . "\", \"reset\")' value='Cancel' /></td></tr>\n";
		print "</table>\n";
		if ($tableGeomEditVal=='Yes'){
	...
	Case 'add':
		...
		print "<table style='table-layout: fixed;'>\n";
		//Insert a submit buttom
		print "<tr><td><input type='button' onclick='gedCall(\"" . $qtable . "\", \"insert\")' value='Insert Row' /></td><td><input type='button' onclick='gedCall(\"" . $qtable . "\", \"reset\")' value='Cancel' /></td></tr>\n";
			...
			if ($ex==1){
				...
				if ($sel==1){
					...
					if ($statusValueno > 0) {
						...
						print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . $inputSize . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
					}
				} elseif ($sel==3) {
					//Option List
					print "<td class='EditValue'>
					...
					//Normal Text
					print "<td class='EditValue'><textarea class='disabled' readonly='readonly' rows='5' cols='" . $colsSize . "' id='T" . $fnarray[$j] . "' name='T" . $fnarray[$j] . "'></textarea></td></tr>\n";
				} elseif ($ftarray[$j]=="bool") {
					//Booleans (yes/no)
					if ($formValue=='t') {
						print "<td class='EditValue'><input type='checkbox' checked='checked' class='disabled' readonly='readonly' id='O" . $fnarray[$j] . "' name='O" . $fnarray[$j] . "' value='" . $fnarray[$j] . "' /></td></tr>\n";
					...
					print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
				} elseif (substr($ftarray[$j],0,4)=="time") {
					print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
				} elseif (substr($ftarray[$j],0,4)=="date") {
					print "<td class='EditValue'><input type='textbox' class='disabled' readonly='readonly' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
				...
				if ($sel==1){
					...
					if ($statusValueno > 0) {
						...
						print "<td class='EditValue'><input type='textbox' size='" . $inputSize . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
					}
				} elseif ($sel==3) {
					//Option List
					print "<td class='EditValue'>
					...
					//Normal Text
					print "<td class='EditValue'><textarea  rows='5' cols='" . $colsSize . "' id='T" . $fnarray[$j] . "' name='T" . $fnarray[$j] . "'></textarea></td></tr>\n";
				} elseif ($ftarray[$j]=="bool") {
					//Booleans (yes/no)
					if ($formValue=='t'){
						print "<td class='EditValue'><input type='checkbox' checked='checked' id='O" . $fnarray[$j] . "' name='O" . $fnarray[$j] . "' value='" . $fnarray[$j] . "' /></td></tr>\n";
					...
					print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /><font color='grey'>Please add a number</font></td></tr>\n";
				} elseif (substr($ftarray[$j],0,4)=="time") {
					print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /><font color='grey'>Please add a timestamp (yyyy-mm-dd hh:mm:ss<a href='#' alt='You may need to add the timezone'>*</a>)</font></td></tr>\n";
				} elseif (substr($ftarray[$j],0,4)=="date") {
					print "<td class='EditValue'><input type='textbox' size='" . ($inputSize * 0.75) . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /><font color='grey'>Please add a date (yyyy-mm-dd)</font></td></tr>\n";
				} else {
					//Anything else
					print "<td class='EditValue'><input type='textbox' size='" . $inputSize . "' id='C" . $fnarray[$j] . "' name='C" . $fnarray[$j] . "' value='' /></td></tr>\n";
				}
		...
		//Insert a submit buttom
		print "<tr><td><input type='hidden' id='Itable' name='Itable' value='" . $table . "' /><input type='hidden' id='Iproj' name='Iproj' value='" . $proj . "' /><input type='button' onclick='gedCall(\"" . $qtable . "\", \"insert\")' value='Insert Row' /></td><td><input type='button' onclick='gedCall(\"" . $qtable . "\", \"reset\")' value='Cancel' /></td></tr>\n";
		print "</table>\n";
