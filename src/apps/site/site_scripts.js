		...
		$.get(queryScript, function(data) {
			...
			$.get(queryScript, function(data) {
				...
				$.get(queryScript, function(data) {
					...
					summaryStr += "<tr><td colspan='3' class='leftbox" + SiteTypeI + "'><h3>Full Site Details <a href='../../rbc/trafficsitesviewer' target='_self'>(Return to map of sites)</a></h3></td></tr>";
					...
					if (utcSite) {
						...
						utcTable += "<tr><td class='rightbox" + SiteTypeI + "' colspan='5'><h3>UTC Details <a href='../../rbc/utcviewer' target='_self' title='This takes you to the manager rather than viewer'>(Return to map of UTC sites)</a></h3></td></tr>";
...
function createUpgradesTab(){
	...
	$.get(queryScript, function(data) {
		...
		$.get(queryScript, function(data) {
			...
			//Prepare the content
			var pUpgrade = "";
			pUpgrade += "<div id='pUpgradeContent'><table width='100%'><tr><td class='leftbox" + SiteTypeI + "' colspan='3'><h3>Planned Upgrades</h3></td><td class='leftbox" + SiteTypeI + "'></td></tr>";
